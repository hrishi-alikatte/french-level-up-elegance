          ...
          <div className="text-foreground/80 leading-relaxed space-y-6 font-body text-sm sm:text-base">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li><strong>Course Preferences:</strong> Preferred French level (A1, A2, B1), batch type choice (Extensive, Weekends, Fast-Track), and preferred currency/payment mode (EUR, INR, or USD).</li>
              </ul>
            </section>
