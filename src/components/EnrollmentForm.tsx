    ...
    <section id="enroll" className="py-20 bg-secondary/50">
      <div className="section-container">
        ...
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto bg-card rounded-xl p-8 shadow-md border border-border/50 space-y-5">
          ...
          <button type="submit" className="w-full bg-primary text-primary-foreground py-3.5 rounded-lg font-heading uppercase tracking-wide text-base hover:opacity-90 transition-opacity shadow-md">
            Submit Enrollment
          </button>
        </form>
      </div>
